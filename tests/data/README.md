...
- `ODD_gamma_10ev_theta90deg_phi0deg_posX0mmY1250mmZ0mm_10GeV_hdbscan_clustering_reference.h5` is the committed reference output for `hdbscan_clustering` on the ODD gamma sample with:
  - `min_cluster_size=5`
  - `min_samples=3`
  - `--use-time`
