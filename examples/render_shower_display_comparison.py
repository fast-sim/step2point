...
from step2point.vis import render_shower_display_comparison_3d
...
def parse_args():
    parser = argparse.ArgumentParser(description="Render a two-panel presentation shower comparison.")
    parser.add_argument("--input", nargs=2, required=True, help="Exactly two HDF5 or EDM4hep ROOT files.")
    parser.add_argument(
        "--panel-title",
        nargs=2,
        metavar=("TITLE1", "TITLE2"),
        help="Optional titles for the two panels.",
    )
    parser.add_argument(
        "--panel-subtitle",
        nargs=2,
        metavar=("SUB1", "SUB2"),
        help="Optional subtitles for the two panels.",
    )
    ...
    parser.add_argument("--figsize", type=float, nargs=2, default=(14.5, 10.5), metavar=("WIDTH", "HEIGHT"))
