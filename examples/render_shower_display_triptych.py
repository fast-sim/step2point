...
from step2point.vis import render_shower_display_triptych_3d
...
def parse_args():
    parser = argparse.ArgumentParser(description="Render a three-panel presentation shower display.")
    parser.add_argument("--input", nargs=3, required=True, help="Exactly three HDF5 or EDM4hep ROOT files.")
    parser.add_argument(
        "--panel-title",
        nargs=3,
        metavar=("TITLE1", "TITLE2", "TITLE3"),
        help="Optional titles for the three panels.",
    )
    parser.add_argument(
        "--panel-subtitle",
        nargs=3,
        metavar=("SUB1", "SUB2", "SUB3"),
        help="Optional subtitles for the three panels.",
    )
    ...
    parser.add_argument("--figsize", type=float, nargs=2, default=(20.0, 10.5), metavar=("WIDTH", "HEIGHT"))
