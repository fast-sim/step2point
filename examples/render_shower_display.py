...
from step2point.vis import render_shower_display_3d
...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs="+",
        required=True,
        help="One or more HDF5 or EDM4hep ROOT files. Use two files for full vs compressed displays.",
    )
    ...
    parser.add_argument("--figsize", type=float, nargs=2, default=(16.0, 12.0), metavar=("WIDTH", "HEIGHT"))
